...
app.innerHTML = `
  <div class="page-shell">
    <header class="site-header container">
      <a class="brand" href="#" aria-label="Matematik Koçum ana sayfa">
        <span class="brand-mark">M</span>
        <span>Matematik Koçum</span>
      </a>
      ...
      <section class="hero container">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            <a class="button button-primary" href="#login">Hemen Başla <span>→</span></a>
            <a class="button button-secondary" href="#features">Platformu Keşfet</a>
          </div>
        ...
        <div class="hero-orbit" aria-hidden="true">
          ...
          <div class="hero-card hero-card-main">
            <div class="mini-top"><span>Gelişim özeti</span><span class="status">+12.4%</span></div>
            <div class="metric">82<span>%</span></div>
            <div class="metric-label">Bu haftaki ilerleme</div>
            <div class="chart">
              <i style="height:34%"></i><i style="height:46%"></i><i style="height:40%"></i><i style="height:62%"></i><i style="height:57%"></i><i style="height:78%"></i><i style="height:92%"></i>
            </div>
            <div class="chart-days"><span>Pzt</span><span>Sal</span><span>Çar</span><span>Per</span><span>Cum</span><span>Cmt</span><span>Paz</span></div>
          </div>
          <div class="hero-card floating-card card-goal"><span class="floating-icon">↗</span><div><b>Hedef ilerliyor</b><small>TYT · 68 → 80 net</small></div></div>
          <div class="hero-card floating-card card-task"><span class="check-icon">✓</span><div><b>Bugünkü hedef</b><small>4 / 5 tamamlandı</small></div></div>
        </div>
      </section>

      <section id="features" class="features container">
        <div class="section-heading"><span class="eyebrow">TEK PLATFORM</span><h2>İhtiyacın olan her şey,<br /><span class="muted-gradient">gereksiz karmaşa olmadan.</span></h2></div>
